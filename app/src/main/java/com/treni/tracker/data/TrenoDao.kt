...
interface TrenoDao {
    ...
    @Query("UPDATE treni_monitorati SET ultimoRitardo = :ritardo, ultimaStazioneNotificata = :stazione, indiceFermataCorrente = :indiceFermata, numeroFermateTotali = :totaleFermate, categoria = :categoria WHERE id = :id")
    suspend fun aggiornaStato(id: Long, ritardo: Int, stazione: String?, indiceFermata: Int?, totaleFermate: Int?, categoria: String?)
