...
class TreniAdapter(
    ...
    inner class TrenoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val progress: com.google.android.material.progressindicator.LinearProgressIndicator? = itemView.findViewById(R.id.progressPercorso)
        private val aggiornamento: android.widget.TextView? = itemView.findViewById(R.id.textUltimoAggiornamento)
        ...
        fun bind(treno: TrenoMonitorato) {
            ...
            aggiornamento?.text = "Monitoraggio attivo"
